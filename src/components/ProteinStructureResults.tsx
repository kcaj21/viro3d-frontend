        ...
        {data.matches?.map((match) => (
          ...
          >
            <div
              ...
              className="result-card hover:-translate-y-1 xs:text-xs transition ease-in-out drop-shadow-md sm:min-h-[20vh] sm:max-h-[20vh] lg:min-h-[15vh] lg:max-h-[15vh] 2xl:min-h-[15vh] 2xl:max-h-[15vh] flex flex-col justify-between border-2 border-[#4a95c0] hover:border-[#50bde5] rounded-md bg-[#f9f9f9]"
            >
              {match.protein_structure.genbank_name.length < 50 ? (
                <ul className="px-4 py-2 2xl:text-xl xl:text-xl lg:text-base sm:text-sm text-[#4a95c0] font-light">
                  <li className="">{match.protein_structure.genbank_name}</li>
                  <li className="text-slate-500 2xl:text-xl lg:text-sm sm:text-xs">
                    {match.protein_structure["Virus name(s)"]}
                  </li>
                </ul>
              ) : (
                <ul className="px-4 py-2 2xl:text-xl lg:text-lg sm:text-sm text-[#4a95c0] font-light">
                  <li className="">
                    <ResultToolTip
