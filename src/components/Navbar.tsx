    ...
    <>
      <nav className='fixed top-0 left-0 right-0 z-20 border-b-2 border-[#d6d5d5] text-[#4a95c0] drop-shadow-md bg-[#e6e6e6]'>
        ...
        <img src='src/assets/CVR_RGB.png' width='200'></img>
          ...
          <form className='w-[40%]' >
            <input onChange={handleText} className=' text-slate-500 pl-4 outline-none h-12 w-full border-none rounded-md text-2xl  bg-[#f9f9f9]' type='text' placeholder='Search by GenbankID, Species, Gene or Sequence...'></input>
          </form>
          <Link to={`resultspage/${searchParam}`}>
