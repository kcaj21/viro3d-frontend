...
const ResultsPage: React.FC<{
  ...
  const { proteinInfo, isLoading } = useProteinData(filterParam, searchParam);
...
<div className="min-h-screen">
        <div className="results-container mt-4 border-0 text-5xl rounded-md  text-slate-500">
            <h1 className='text-[#4a95c0] font-medium'>Oh no, it looks like your structure hasn't been predicted yet :(</h1>
        </div>
      </div>
    </>
  ) : (
