  ...
  return (
    <>
      <div className="min-h-screen">
        <FeatureBrowser />
        <div className="results-container mt-4 border-0 text-5xl  rounded-md text-slate-500 bg-[#e6e6e6]">
            ...
            {proteinInfo.map((protein, index) => (
              <Link to={{ pathname: `/structureindex/${protein.protein_id}` }}>
                <div
                  ...
                  className="result-card flex flex-col-2 gap-8 border-2 hover:border-[#4a95c0] rounded-md mt-4 mb-4 bg-[#f9f9f9]"
                >
