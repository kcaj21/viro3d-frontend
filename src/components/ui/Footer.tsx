...
const Footer: React.FC = () => {
  return (
    <>
      <footer id="footer" className="desktop-footer xs:hidden lg:block border-t-2  border-[#d6d5d5] text-[#4a95c0] drop-shadow-md bg-[#e6e6e6]">
      ...
      <footer id="footer" className="mobile-footer lg:hidden border-t-2 border-[#d6d5d5] text-[#4a95c0] drop-shadow-md bg-[#e6e6e6]">
