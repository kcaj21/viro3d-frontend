...
const Footer: React.FC = () => {
  return (
    <>
      ...
      >
        <div className="flex md:justify-center gap-8 px-8 mx-auto py-4">
      ...
      <footer
        id="footer"
        className={`mobile-footer lg:hidden border-t-2 ${isMobile ? `hidden` : ``} border-[#d6d5d5] text-[#4a95c0] drop-shadow-md bg-[#e6e6e6]`}
      >
