...
//   const colourKeys = {"Riboviria": "#5cb7a8", "Monodnaviria": "#b87795", "Unclassified": "gray", "Varidnaviria": "#f1e9c5", "Ribozyviria": "#117733", "Duplodnaviria": "#8b81b9" }
  ...
  return (
    <>
        <div className="flex flex-col mx-2 my-2 px-2 py-2 border-0 text-xl rounded bg-[#e6e6e6de] gap-2">
        <button onClick={handleLegendPopUpClick} className="text-[#6d828d] text-2xl border-b hover:border-[#505f66] hover:text-[#505f66]">Hide Legend</button>
